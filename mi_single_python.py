# Combined Market Intelligence System for UBPP Logam Mulia
# All modules merged into one file for simplicity
...
def detect_price_gap(lm_price, competitor_df):
    ...
    competitor_df["status"] = competitor_df["gap"].apply(lambda x: "lebih murah" if x < 0 else "lebih mahal")
