...
# ===========================================================
    ...
    with col3:
        ...
        if galeri24 and isinstance(galeri24, dict):
            st.metric("Harga Jual", f"Rp {galeri24.get('jual', 0):,}")
            st.metric("Harga Beli", f"Rp {galeri24.get('beli', 0):,}")
            st.caption(f"Update: {galeri24.get('last_update', '—')}")
        else:
